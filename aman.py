...
async def start_yukki():
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await wdk(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await wdk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await wdk(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await wdk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await hdk(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await hdk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await hdk(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await hdk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await sdk(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await sdk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await sdk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await sdk(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await adk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await adk(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await adk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await adk(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await bdk(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await bdk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await bdk(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await bdk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await cdk(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await cdk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await cdk(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await cdk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await ddk(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await ddk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await ddk(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await ddk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await edk(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await edk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await edk(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await edk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await vkk(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await vkk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await vkk(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await vkk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await kkk(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await kkk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await kkk(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await kkk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await lkk(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await lkk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await lkk(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await lkk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await mkk(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await mkk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
            await mkk(functions.channels.JoinChannelRequest(channel="@KGFLONDA"))
            await mkk(functions.channels.JoinChannelRequest(channel="@KGFFIGHTER786"))
...
async def ping(e):
    if e.sender_id in SMEX_USERS:
        start = datetime.now()
        text = "❀❀MEGASTAR Mʊʟȶɨ ֆքǟʍ ɮօȶ ❀❀!"
        event = await e.reply(text, parse_mode=None, link_preview=None )
        end = datetime.now()
        ms = (end-start).microseconds / 1000
        await event.edit(f" 𝙋𝙄𝙉𝙂 !\n`{ms}` ms{ALIVE_NAME} ❀❀MEGASTAR ֆքǟʍ ɮօȶ❀❀")
